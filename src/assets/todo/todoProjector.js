...
const todoTextProjector = todo => {
    ...
    inputElement.oninput = () => todo.setText(inputElement.value);
...
const todoDoneProjector = todo => {
    ...
    checkboxElement.onclick = () => todo.setDone(checkboxElement.checked);
...
const todoItemProjector = (todoController, rootElement, todo) => {
    ...
    deleteButton.onclick    = () => todoController.removeTodo(todo);
